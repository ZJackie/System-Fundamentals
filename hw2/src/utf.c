...
get_encoding_function()
{
  ...
  //int (*encode)(int,int);
  convertion_func_t encode;
  switch (translate) {
    case utf8_to_utf16le:
      encode = from_utf8_to_utf16le;
      return encode;
    case utf8_to_utf16be:
      encode = from_utf8_to_utf16be;
      return encode;
    case utf16le_to_utf16be:
      encode = from_utf16le_to_utf16be;
      return encode;
    case utf16be_to_utf16le:
      encode = from_utf16be_to_utf16le;
      return encode;
    case utf16be_to_utf8:
      encode = from_utf16be_to_utf8;
      return encode;
    case utf16le_to_utf8:
      encode = from_utf16le_to_utf8;
      return encode;
...
utf16_glyph_to_code_point(utf16_glyph_t *glyph)
{
  ...
  debug("Algorithm = true");
  debug("Upper: %x ", glyph->upper_bytes);
  debug("Lower: %x ", glyph->lower_bytes);
