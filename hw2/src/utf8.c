...
{
  //utf8_glyph_t (*encode)(code_point_t);
  utf8_encoding_func_t encode;
  switch(size) {
  case 1:
    encode = utf8_one_byte_encode;
    return encode;
  case 2:
    encode = utf8_two_byte_encode;
    return encode;
  case 3:
    encode = utf8_three_byte_encode;
    return encode;
  case 4:
    encode = utf8_four_byte_encode;
...
{
  switch(size) {
  utf8_decoding_func_t decode;
  case 1:
    decode = &utf8_one_byte_decode;
    return decode;
  case 2:
    decode = &utf8_two_byte_decode;
    return decode;
  case 3:
    decode = &utf8_three_byte_decode;
    return decode;
  case 4:
    decode = &utf8_four_byte_decode;
    return decode;
  }
  return NULL;
}
